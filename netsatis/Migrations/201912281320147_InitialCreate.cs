                ...
                c => new
                    {
                        ...
                        İskontoOrani = c.Decimal(nullable: false, precision: 5, scale: 2),
                        İskontoTutar = c.Decimal(nullable: false, precision: 12, scale: 2),
                ...
                c => new
                    {
                        ...
                        StokAdi = c.String(maxLength: 12),
                        BarkodTuru = c.String(maxLength: 50),
                        ...
                        IndirimTutari = c.Decimal(nullable: false, precision: 5, scale: 2),
                        ToplamTutar = c.Decimal(nullable: false, precision: 12, scale: 2),
                        DepoKodu = c.String(maxLength: 12),
                        DepoAdi = c.String(maxLength: 30),
                ...
                c => new
                    {
                        ...
                        AlisFiyati1 = c.Decimal(nullable: false, precision: 12, scale: 3),
                        AlisFiyati2 = c.Decimal(nullable: false, precision: 12, scale: 3),
                        AlisFiyati3 = c.Decimal(nullable: false, precision: 12, scale: 3),
                        SatisFiyati1 = c.Decimal(nullable: false, precision: 12, scale: 3),
                        SatisFiyati2 = c.Decimal(nullable: false, precision: 12, scale: 3),
                        SatisFiyati3 = c.Decimal(nullable: false, precision: 12, scale: 3),
                        MinStokMiktari = c.Decimal(nullable: false, precision: 12, scale: 2),
                        MaxStokMiktari = c.Decimal(nullable: false, precision: 12, scale: 2),
                        Aciklama = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.Id);
