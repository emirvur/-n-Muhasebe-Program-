...
namespace netsatis.Mapping
{
    public class StokMap : EntityTypeConfiguration<Stok>
    {
        public StokMap()
        {
            ...
            this.Property(p => p.AlisFiyati1).HasPrecision(12,3);
            this.Property(p => p.AlisFiyati2).HasPrecision(12,3);
            this.Property(p => p.AlisFiyati3).HasPrecision(12,3);
            this.Property(p => p.SatisFiyati1).HasPrecision(12,3);
            this.Property(p => p.SatisFiyati2).HasPrecision(12,3);
            this.Property(p => p.SatisFiyati3).HasPrecision(12,3);
            this.Property(p => p.MinStokMiktari).HasPrecision(12,2);
            this.Property(p => p.MaxStokMiktari).HasPrecision(12,2);
